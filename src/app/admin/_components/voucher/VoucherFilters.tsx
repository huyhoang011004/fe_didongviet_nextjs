...
export function VoucherFilters({
  ...
  return (
    <div className='p-6 bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 flex flex-col md:flex-row gap-4 items-center justify-between'>
      <div className='flex flex-wrap gap-1.5 p-1 bg-slate-100 dark:bg-slate-800 rounded-xl w-full md:w-auto'>
        {[
          ...
          <button
            ...
            className={`
              flex-1 md:flex-none px-4 py-2 text-xs font-bold rounded-lg transition-all border-none cursor-pointer
              ${
