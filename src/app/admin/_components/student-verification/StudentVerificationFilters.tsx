...
export function StudentVerificationFilters({
  ...
  return (
    <div className='p-6 bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row gap-4 items-center justify-between'>
      <div className='flex items-center gap-1.5 p-1 rounded-xl w-full sm:w-auto'>
        <span className='px-4 py-2 text-xs font-bold bg-amber-50 dark:bg-amber-950/30 text-amber-600 border border-amber-200 dark:border-amber-900/50 rounded-lg'>
          Chờ phê duyệt
        </span>
      </div>
